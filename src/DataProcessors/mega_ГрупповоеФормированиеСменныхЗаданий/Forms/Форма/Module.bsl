...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	Если ИсточникВыбора.ИмяФормы = 
		"Обработка.mega_ГрупповоеФормированиеСменныхЗаданий.Форма.ФормаВыбораПродукцииПроизводственногоРесурса" Тогда
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыОстаткиРесурсов

&НаКлиенте
Процедура ОстаткиРесурсовВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	
	ТекущаяСтрока = Элементы.ОстаткиРесурсов.ТекущиеДанные;
	...
	ПараметрыОткрытия.Вставить("ПроизводственныйРесурс", ТекущаяСтрока.Ресурс);
	
	ОткрытьФорму("Обработка.mega_ГрупповоеФормированиеСменныхЗаданий.Форма.ФормаВыбораПродукцииПроизводственногоРесурса", 
...
Процедура ОбработкаВыбораНаСервере(ВыбранноеЗначение)
	 ...
	 Строки = Объект.Состав.НайтиСтроки(ВыбранноеЗначение);
	 Если Строки.Количество() = 0 Тогда
	 	...
	 	НоваяСтрока.Количество = 
	 		ОбщегоНазначения.ЗначениеРеквизитаОбъекта(НоваяСтрока.Спецификация, "Количество"); 
	 КонецЕсли;
КонецПроцедуры
...
&НаСервере
Процедура ЗаполнитьВидыСтадииОбработки(СтрокаСостав)
