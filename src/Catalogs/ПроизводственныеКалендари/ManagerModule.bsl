...
// 
// Параметры:
//  ДанныеПроизводственногоКалендаря - ТаблицаЗначений - см. функциию ДанныеПроизводственногоКалендаря 
//  ПроверяемаяДата -Дата - Проверяемая дата
// 
// Возвращаемое значение:
//  Булево - Это рабочий день
Функция ЭтоРабочийДень(ДанныеПроизводственногоКалендаря, ПроверяемаяДата)Экспорт
