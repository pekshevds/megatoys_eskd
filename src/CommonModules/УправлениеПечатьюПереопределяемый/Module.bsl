...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	//+mega
	СписокОбъектов.Добавить(Документы.mega_ПроизводственнаяОперация);
	СписокОбъектов.Добавить(Документы.mega_ПроизводственнаяОперацияСводная);
	СписокОбъектов.Добавить(Документы.mega_Болванка);
	СписокОбъектов.Добавить(Документы.mega_ПланПроизводства);
	СписокОбъектов.Добавить(Документы.mega_СменноеЗадание);
	СписокОбъектов.Добавить(Документы.mega_ЗаявкаВнутренняя);
	СписокОбъектов.Добавить(Документы.mega_ЗакрытиеЗаявокВнутренних);
	СписокОбъектов.Добавить(Документы.mega_ЗаявкаПоставщику);
	СписокОбъектов.Добавить(Документы.mega_ЗакрытиеЗаявокПоставщикам);
	СписокОбъектов.Добавить(Документы.mega_ПеремещениеМеждуПодразделениями);
	СписокОбъектов.Добавить(Документы.mega_ПередачаНаСклад);
	СписокОбъектов.Добавить(Документы.mega_ПередачаВПроизводство);
	СписокОбъектов.Добавить(Документы.mega_ЗаявкаНаПеремещение);
	//-mega
